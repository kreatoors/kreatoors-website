  ...
  "employer-content-creation": {
    h1: (
      <h1 className="text-[34px] sm:text-3xl md:text-4xl lg:text-5xl leading-tight">
        ...
        <span className="mt-4 block"> for Activating </span>
        <span className="mt-4 block"> Employee Voices</span>
      </h1>
    ),
    description:
      "We balance empowerment with content control, ensuring advocacy aligns with organisational goals while safeguarding your brand’s integrity. ",
    ...
    coreServices: [
      {
        id: "evp-culture",
        title: "Advocacy-in-a-Box Activation",
        subtitle: "Turn employees into active advocates in 30 days.",
        description2:
          "A time-boxed programme that gets people posting with confidence — without long-term commitment. Launch employee advocacy quickly, safely, and with momentum.",
        description: "Including: ",
        content: [
          "4–6 week, clearly scoped activation",
          "Personal brand baseline for participants",
          "Practical posting prompts and examples",
          "Simple goals to build early momentum",
          "Designed to move teams from zero to active and posting confidently, fast",
        ],
      },
      {
        id: "culture-storytelling",
        title: "Employee Personal Brand Enablement ",
        subtitle: "Make employee visibility personal, not generic.",
        description2:
          "We help employees understand their personal brand, strengthen it, and show up consistently on LinkedIn. Each participant gets a clear score, focus areas, and a practical action plan.",
        description: "Whats included: ",
        content: [
          "Individual personal brand score and focus areas ",
          "Practical, personalised action plan per employee",
          "Content prompts tailored to each person’s role and strengths",
          "Peer feedback to build confidence and quality",
          "Supports consistency without forcing sameness ",
        ],
      },
      {
        id: "candidate-experience",
        title: "Campaign-Based Advocacy",
        subtitle: "Mobilise employees around moments that matter.",
        description2:
          "From hiring pushes to product launches, we design and run focused advocacy campaigns with a clear start, end, and outcome — aligned to real business priorities.",
        description: "Including: ",
        content: [
          "Time-boxed advocacy campaigns (hiring, launches, thought leadership)",
          "Clear narrative and campaign objectives",
          "Content prompts aligned to each campaign phase",
          "Easy for employees to participate",
          "Outputs reusable across teams and markets",
        ],
      },
      {
        id: "candidate-experience-",
        title: "Advocacy Governance & Enablement",
        subtitle: "Scale advocacy without losing control.",
        description2:
          "We put the right guardrails in place: content frameworks, approval flows, templates, and playbooks — so teams can create and share content safely, fast, and at scale.",
        description: "Including:",
        content: [
          "Participation-based recognition frameworks",
          "Clear guardrails for safe, on-brand sharing ",
          "Content frameworks employees can follow",
          "Approval workflows where needed",
          "Templates and playbooks for self-serve creation",
          "Reduces risk without slowing teams down",
        ],
      },
    ],
    impactItems: [
